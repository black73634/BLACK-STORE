                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script BLACK HUB Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "rbxassetid://129945785974414" }),
...
setclipboard("BLACK HUB Is The Best")
...
Tabs.Main:AddButton({
        Title = "BLACK HUB Discord Server",
...
Fluent:Notify({
    Title = "BLACK HUB",
    Content = "Thanks For Using BLACK HUB",
    Duration = 8
})
